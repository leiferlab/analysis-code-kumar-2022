# This is the code used to analyze the data presented in Kumar, Sharma and Leifer, titled "An inhibitory circuit for rapid contextual modulation of mechanosensory processing in *C. elegans*". 
